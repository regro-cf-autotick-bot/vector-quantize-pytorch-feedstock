...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vector-quantize-pytorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13078&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vector-quantize-pytorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vector-quantize-pytorch` can be installed with:

```
conda install vector-quantize-pytorch
```

It is possible to list all of the versions of `vector-quantize-pytorch` available on your platform with:
